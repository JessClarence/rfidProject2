...
namespace rfidProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = CreateUser();
                //slaughterhouse
                user.SlaughterHouse = new SlaughterHouse();
                user.SlaughterHouse.AccreditationRate = Input.SlaughterHouse.AccreditationRate;
